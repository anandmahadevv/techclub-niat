  ...
  return (
    <div className="flex-grow w-full min-h-screen flex items-center justify-center p-4 sm:p-8 relative bg-slate-50 overflow-hidden font-sans">
      ...
      <button
        type="button"
        onClick={() => navigate(-1)}
        className="absolute top-5 left-5 z-50 hidden md:flex items-center gap-2 px-3 py-2 text-sm font-semibold text-slate-600 hover:text-indigo-700 bg-white/70 hover:bg-white backdrop-blur-sm border border-white/60 hover:border-indigo-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 group"
      >
