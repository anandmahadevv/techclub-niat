      ...
      <div className="w-full max-w-md bg-white/70 dark:bg-zinc-900/60 backdrop-blur-xl border border-gray-200/55 dark:border-zinc-800/60 shadow-2xl rounded-3xl p-8 relative z-10 transition-all">
        {verificationSent ? (
          <div className="text-center py-6 flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-green-50 dark:bg-green-950/20 text-green-600 dark:text-green-400 flex items-center justify-center text-2xl mb-6">
              <i className="fas fa-paper-plane animate-pulse"></i>
            </div>
            <h2 className="text-2xl font-black tracking-tight text-gray-950 dark:text-white mb-3">
              Confirm Your Email
            </h2>
            <p className="text-sm text-gray-500 dark:text-zinc-400 leading-relaxed mb-6">
              ...
              Please click the link inside that email to confirm and activate your account.
            </p>
            <div className="w-full p-4 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-100 dark:border-yellow-900/30 rounded-2xl mb-8 text-left text-xs text-yellow-800 dark:text-yellow-400 leading-relaxed">
              <i className="fas fa-exclamation-triangle mr-2"></i>
              Note: Email verification is required <strong>only once</strong> upon registration. Once confirmed, you can log in directly at any time.
            </div>
            <button
              onClick={() => {
              ...
              className="w-full bg-gradient-to-r from-red-600 to-orange-500 hover:opacity-90 text-white font-bold py-3.5 px-6 rounded-xl transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
            >
